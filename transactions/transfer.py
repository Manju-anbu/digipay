...
def search_user(request):
    ...
    return render(request,'transfer/search_user.html',context)
...
def amount_transfer_process(request,account_number):
    ...
    return render(request,'transfer/amount_transfer_process.html',{'account':account})
...
def transfer_success(request,account_number,transaction_id):
    ...
    return render(request,'transfer/transfer_success.html',context)
...
#    kyc=KYC.objects.get(user=user)
   ...
   return render(request,'transfer/transaction_detail.html',context)
...
def transactions_list(request):
    ...
    return render(request,'transfer/transactions_list.html',context)
